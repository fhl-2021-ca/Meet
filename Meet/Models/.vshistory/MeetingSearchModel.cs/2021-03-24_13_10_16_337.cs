...
namespace Meet.Models
{
    public class MeetingSearchModel
    {
        ...
        public MeetingSearchModel(string meetingId, string userId, string name, List<UserAction>? userActions = null, string alias, int? duration, long? actionTime, bool? isSnoozed)
        {
