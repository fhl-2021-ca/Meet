...
namespace Meet.Models
{
    public class MeetingSearchModel
    {
        ...
        public MeetingSearchModel(string meetingId, string userId, string name, string alias, List<UserAction> userActions = null, int? duration, long? actionTime, bool? isSnoozed)
        {
