...
namespace Meet.Controllers
{
    public class MeetingController : Controller
    {
        ...
        public IActionResult Search(string meetingId, string name, string time, string actionTime)
        {
        ...
        public string Snooze(string meetingId, string userId, string time, string actionTime)
        {
            // TODO : emit userData here
