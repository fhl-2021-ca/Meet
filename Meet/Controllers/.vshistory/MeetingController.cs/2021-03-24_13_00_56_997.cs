...
namespace Meet.Controllers
{
    public class MeetingController : Controller
    {
        ...
        public IActionResult Join(string meetingId, string userId)
        {
            ...
            userActions.Add(new UserAction(132, "Joined User", "Joined"));
            userActions.Add(new UserAction(132, "Declined User", "Declined"));
            userActions.Add(new UserAction(132, "Late User", "Late", 5));
            userActions.Add(new UserAction(132, "NoResponse User", "Invited"));

        var model = new MeetingSearchModel(meetingId, userId, name, userActions, alias, null, null, false);
