...
namespace Meet.Controllers
{
    public class MeetingController : Controller
    {
        ...
        public IActionResult Snooze(string meetingId, string userId, string alias, int time, long actionTime)
        {
            // TODO : emit userData here

            return Search(meetingId, userId, alias, time, actionTime, true);
